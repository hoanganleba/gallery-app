    ...
    <div class="w-screen min-h-screen h-screen bg-neutral-950 overflow-hidden">
      <Switch fallback={<div>Not Found</div>}>
        <Match when={!isStringEmpty(dirPath())}>
          <TitleBar>
            <div class="flex h-full w-full justify-center items-center px-4 space-x-1">
              <button
                onClick={openDialog}
                class="text-neutral-50/80 p-1 hover:bg-neutral-800 transition duration-100 rounded"
              >
        ...
        <Match when={isStringEmpty(dirPath())}>
          ...
          <div class="flex justify-center items-center h-full w-full p-10">
            <div
              onClick={openDialog}
              class="text-white bg-neutral-900 w-[680px] h-64 flex justify-center items-center rounded-xl cursor-pointer"
            >
              <div>
