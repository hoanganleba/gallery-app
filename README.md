...
- Browse and view images, videos
- Zoom in and out on images for detailed viewing
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/hoanganleba/gallery-app.git
   ```
...
Contributions to the Gallery App are welcome! If you find any issues or have suggestions for improvements, please feel free to open an issue or submit a pull request. Make sure to follow the project's code of conduct.
